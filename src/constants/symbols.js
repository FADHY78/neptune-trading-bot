export const DERIV_SYMBOLS = [
  // Standard Volatility Indices — publicly accessible with any app_id
  ...
  { symbol: 'R_100', name: 'Volatility 100 Index', category: 'Continuous', defaultChecked: true },

  // 1-Second Volatility Indices — require a registered Deriv app_id
  ...
  { symbol: '1HZ100V', name: 'Volatility 100 (1s) Index', category: 'Continuous (1s)' },
